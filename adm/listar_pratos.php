    ...
    <div class="row centered-form">
      <div class="col-lg-12 ">
        ...
        <?php 
          ...
          sempre irá exigir dois parâmetros: o primeiro é a conexão com o banco
          e o segundo é o comando que será executado
          */
          ...
          // mysqli_fetch_array transforma os resultados em vetores
