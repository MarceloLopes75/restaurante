<html>
    ...
    <body>
        ...
        <main class="container">
            <h1>Insira as informações da reserva</h1>
            <br>
            <form class="form-horizontal" action="cadastrar-reservas.php" method="POST" role="form" data-toggle="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="datetime-local" class="form-control" name="data" id="data" placeholder="Selecione a data" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" name="npessoas" id="npessoas" placeholder="" >
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
